...
import com.fsnajafali.memoryboost.utils.*
...
class CreateActivity : AppCompatActivity()
{
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTOS_CODE)
        {
            ...
            {
                Toast.makeText(this, "In order to create a custom plan, you need to provide access to your photos", Toast.LENGTH_LONG).show()
            }
        }
